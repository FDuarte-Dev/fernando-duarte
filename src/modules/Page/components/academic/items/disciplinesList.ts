...
export const ASA: Discipline = {
    name: 'Análise de Síntese de Algoritmos',
    ects: 6.0,
    projects: [
        {
...
export const IPM: Discipline = {
    name: 'Interfaces Pessoa Máquina',
    ects: 7.5,
    projects: [
        {
            name: 'BarISTa',
...
export const EO: Discipline = {
    name: 'Electromagnetismo e Óptica',
    ects: 6.0
}
